...
The overall accuracy of the classifier was 70%. All of the misclassified emails were relevant emails that the classifier thought were non-relevant. The first misclassified email, _relevant_test_5_, was an email to W&M students from the registrar in Winter 2024 introducing what PATH registration is. Another misclassified email, _relevant_test_2_, was an email from Ginger Ambler about volunteering and other events surrounding spring graduation in May 2024. I believe that both of these emails may have been misclassified due to their references to signing up and registering for different events, such as the frequent occurrences of 'sign-up' and 'registration'. There were many emails in the training set that belonged to the non-relevant category and were about signing up or registering for different events, such as those hosted by Girls Who Code or LinkedIn webinars, and many emails included a closing sentence that said 'Sign up here to get this newsletter in your inbox', or another similar line. The volunteering email may have been additionally misclassified because there were several emails in the non-relevant training set that were email blasts about volunteer opportunities or were from nonprofit organizations. As for the last misclassified email, _relevant_test_4_, this was a very short email from Information Technology about the W&M Mobile app. The email mostly talks about giving feedback on the app, and not about facets of the app itself, which may have contributed to the misclassification because there were several emails in the training set asking for 'feedback', 'interest', and 'participation'.
...
The classifier performed moderately, with a 70% accuracy, but it performed better in classifying non-relevant emails as non-relevant than relevant emails as relevant. The true negatives, of which there were five, indicate that the classifier accurately deduced that all five non-relevant emails were non-relevant. However, the true positives, two, indicate that the classifier only correctly deduced two out of the five relevant emails, incorrectly classifying the rest of the relevant emails as non-relevant. This is not what we want from an email classifier in this case, because we failed to identify three relevant emails. There are no false positives, meaning that the classifier did not mistake any non-relevant emails to be relevant.

**B: Would you prefer an email classifier to have more false positives or more false negatives? Why?**

I would prefer the classifier to have more False Positives in this case than False Negatives, because we are trying to decipher which emails belong to the 'positive' group, the relevant emails, and the rest are all miscellaneous spam. False positives would mean that non-relevant emails, like spam email, would be classified as relevant. Though this could be irritating as you are seeing spam emails that you don't want to, it's better than the alternative, false negatives, which would lead to missing important/relevant emails that are incorrectly classified as spam.
